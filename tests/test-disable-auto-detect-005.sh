...
# test-disable-auto-detect-005.sh - DISABLE AUTO-DETECTION TESTS - NOT FOUND
...
# ============================================================================
# DISABLE AUTO-DETECTION TESTS - NOT FOUND
# ============================================================================
test_disable_auto_detect_not_found() {
    log_test "test_disable_auto_detect_not_found" \
    ...
    assert_exit_code $exit_code 1 "guard disable should fail for non-existent target"
...
# Run test
run_test test_disable_auto_detect_not_found
