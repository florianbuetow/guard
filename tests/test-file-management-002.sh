...
# test-file-management-002.sh - REMOVE FILE TESTS
...
# REMOVE FILE TESTS
# ============================================================================
test_remove_file_positive() {
    log_test "test_remove_file_positive" \
             "Positive test: Remove registered file and restore permissions"
    ...
    # Run remove
    $GUARD_BIN remove file test.txt
    local exit_code=$?

    # Assert
    assert_exit_code $exit_code 0 "guard remove file should succeed"
...
# Run test
run_test test_remove_file_positive
